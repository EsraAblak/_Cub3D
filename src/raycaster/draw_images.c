...
/*   Updated: 2023/06/05 16:19:53 by eablak           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	image_put_pixel(t_image *img, int x, t_all *all)
{
	...
	all->mlx->mlx_img_addr[all->rc->start * all->rc->window_width + x] = color;
}
...
void	draw_images(t_all *all, int x)
{
	...
	all->rc->tex_pos = (all->rc->start - all->rc->window_height / 2
